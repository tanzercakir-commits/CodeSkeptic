...
| ContractInfo | `src/contracts/ContractInfo.h`, `.cpp` | Done (Round C: shared requires recognizer; NullDeref/DivByZero seed + call-site checks) |
...
| GTest infrastructure | `tests/` | Done (363/363; ctest + single-process) |
