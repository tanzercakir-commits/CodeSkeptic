...
- Independent Phase 9 evidence audit: the earlier eight current-head summaries remain operational history, but their three raw receipts were not retained. They are not completion evidence and will be repeated with durable receipt retention before Phase 9 can close. TensorFlow Lite and shadPS4 are now bound to the retained-evidence gate.
