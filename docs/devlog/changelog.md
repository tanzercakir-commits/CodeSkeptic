...
- The public quality-floor operator verifies that build authority before any
  ...
  atomic promotion. The exact-head authoritative campaign and retained evidence
  are still pending; this checkpoint does not close `CS-P10-08` and does not
  change protected-main status.
