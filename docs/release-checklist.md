...
| Output, discovery and verdict contract | **O** | CH03-S01-U002: five output-parity tests, capability/producer/CWE checks and 52 compilation-input tests. Later **L** four-format artifact parity and **N** native 0/1/2 scans are additional, separately bound evidence. |
