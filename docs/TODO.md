...
**Slice 9.3 retained current-head evidence GREEN:** all eleven candidates are
now bound to the retained-evidence gate with an exact manifest and three fresh,
checksummed raw receipts. This proves deterministic current-head qualification;
it does not change the separately governed accepted-upstream ledger.
