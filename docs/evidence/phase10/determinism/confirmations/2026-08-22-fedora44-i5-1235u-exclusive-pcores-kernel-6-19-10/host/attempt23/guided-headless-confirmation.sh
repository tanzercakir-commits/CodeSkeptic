...
readonly operator_root=/home/tanzer/Projects/CodeSkeptic/build/p10-07-v7-confirmation-operator-88e369b-attempt23
readonly authorizer=$operator_root/authorize-headless-confirmation.sh
readonly authorizer_sha=f67c16911f53419f09b204cd68869c2ab17bbdf18507bc528575225de73bd400
...
readonly headless_log=$headless_root/88e369b-confirmation-v7-23.log
readonly terminal_receipt=$headless_root/88e369b-confirmation-v7-23.terminal
readonly transaction_journal=$headless_root/88e369b-confirmation-v7-23.journal
readonly transaction_journal_sha=$headless_root/88e369b-confirmation-v7-23.journal.sha256
readonly recovery_script=$headless_root/recover-88e369b-confirmation-v7-23.sh
readonly active_stage=/home/tanzer/Projects/CodeSkeptic/build/p10-07-v7-confirmation-88e369b-attempt23
readonly authority_cgroup=/sys/fs/cgroup/codeskeptic-p10-07-authority
readonly result_file=/home/tanzer/Projects/CodeSkeptic/build/p10-07-v7-guided-confirmation-88e369b-attempt23.result
readonly precontroller_status=/home/tanzer/Projects/CodeSkeptic/build/p10-07-v7-confirmation-precontroller-88e369b-attempt23.status
readonly helper_log=/home/tanzer/Projects/CodeSkeptic/build/p10-07-v7-confirmation-vscode-helper-88e369b-attempt23.log
...
transition_graphical_counter_after_receipt() {
  ...
  [[ $load == loaded && $state == active && \
        ...
        $accepted == 0 ]] || return 2
  drkonqi_accepted_before_isolate=0
}
...
for path in "$headless_log" "$terminal_receipt" "$transaction_journal" "$transaction_journal_sha" \
  ...
  [[ ! -e $path && ! -L $path ]] || fail "88e369b-confirmation-v7-23 yolu zaten mevcut: $path"
done
