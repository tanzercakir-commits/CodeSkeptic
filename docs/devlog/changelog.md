...
- Kept the generic per-artifact snapshot ceiling at 512 MiB while allowing the
  real-world mirror's initial verification and end-of-session identity recheck
  to use the mirror consumer's explicit bounded bundle limit. This admits the
